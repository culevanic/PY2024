...
# CODUL TĂU VINE MAI JOS:
text = 'Odată cu sosirea primăverii \ntotul revine la viață. \nPomii se îmbracă în straie verzi, \nFlorile ne bucură cu culori divine, \nPăsărelele cântă vesel.'
print(text)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
f_string = f'Eu ma numesc {name} si am un verisor cu numele {name2}!'
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
format_string = 'Eu sunt {} si vecinul meu este {}.'.format(name, name2)
print(format_string)
# CODUL TĂU VINE MAI SUS:
